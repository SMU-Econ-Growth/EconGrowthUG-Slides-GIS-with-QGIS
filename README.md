# Economic Growth Slides GIS with QGIS
---

Reveal.js slides for Economic Growth course from [Jupyter Notebook "GIS with QGIS"](https://github.com/SMU-Econ-Growth/EconGrowthUG-Notebooks/blob/main/GIS.ipynb)
